...
exports.reply = function* (next) {
	...
	if (message.MsgType === 'event') {
		...
		if (content === '1') {
			...
			// 上传临时素材
			var data = yield wechatApi.uploadMaterial('image', path.join(__dirname, '../public/images/2.jpg'));
			...
			var data = yield wechatApi.uploadMaterial('video', path.join(__dirname, '../public/videos/lq.mp4'));
			...
			// 上传永久素材(未授权)
			var data = yield wechatApi.uploadMaterial('video', path.join(__dirname, '../public/videos/lq.mp4'), {type: 'video', description: '{"title": "一个好的微信公众号", "introduction": "So easy"}'});
			...
			var picData = yield wechatApi.uploadMaterial('image', path.join(__dirname, '../public/images/1.jpg'), {});
			console.log(picData);
			var media = {
				"atricles": [{
					"title": '111111',
